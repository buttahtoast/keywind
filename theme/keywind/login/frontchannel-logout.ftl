...
<@layout.registrationLayout; section>
  ...
  <#elseif section="form">
    <p class="text-secondary-600 text-sm dark:text-secondary-300">${msg("frontchannel-logout.message")}</p>
    <ul class="space-y-2 text-secondary-600 text-sm dark:text-secondary-300">
